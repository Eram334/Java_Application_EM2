...
<html>
	...
	<div id="header">
			...
			<tr><td><div><marquee direction="up" width="300px" truespeed="truespeed" onmouseover="stop()" onmouseout="start()" style="color: red;">Last Date of fee Submission is 30/06/2021
	...
	<div id="sidebar">
			...
			<div id="header">
					<h4>
						Copyright 2021 All rights reserved.fore more information please visit: <a href="https://eram334.github.io/eramperwez/"><font style="color: yellow;">  click here	</font></a>
					</h4>
			</div>
